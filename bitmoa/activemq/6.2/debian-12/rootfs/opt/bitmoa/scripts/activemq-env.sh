...
export BITMOA_VOLUME_DIR="/bitnami"
...
# Paths
export ACTIVEMQ_BASE_DIR="${BITMOA_ROOT_DIR}/activemq"
export ACTIVEMQ_BIN_DIR="${ACTIVEMQ_BASE_DIR}/bin"
export ACTIVEMQ_VOLUME_DIR="${BITMOA_VOLUME_DIR}/activemq"
...
export PATH="${ACTIVEMQ_BASE_DIR}/bin:${JAVA_HOME}/bin:${BITMOA_ROOT_DIR}/common/bin:${PATH}"
