...
```console
docker run --name minio-object-browser bitmoa/minio-object-browser:latest
```
...
The recommended way to get the Bitnami Bitnami Console based on MinIO&reg; Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/minio-object-browser).

```console
docker pull bitmoa/minio-object-browser:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/minio-object-browser/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/minio-object-browser:[TAG]
```
...
To run commands inside this container you can use `docker run`, for example to execute `console help` you can follow the example below:

```console
docker run --rm --name minio-object-browser bitmoa/minio-object-browser:latest help
```
