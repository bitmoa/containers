...
```console
docker run --name kserve-localmodel-controller bitmoa/kserve-localmodel-controller:latest
```
...
The recommended way to get the Bitnami KServe Local Model Node Agent Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/kserve-localmodel-controller).

```console
docker pull bitmoa/kserve-localmodel-controller:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/kserve-localmodel-controller/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/kserve-localmodel-controller:[TAG]
```
...
```console
docker run --rm --name kserve-localmodel-controller bitmoa/kserve-localmodel-controller:latest --  --help
```
