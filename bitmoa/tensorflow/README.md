...
```console
docker run -it --name tensorflow bitmoa/tensorflow
```
...
The recommended way to get the Bitnami Tensorflow Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/tensorflow).

```console
docker pull bitmoa/tensorflow:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/tensorflow/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/tensorflow:[TAG]
```
...
```console
docker run -it --name tensorflow -v /path/to/app:/app bitmoa/tensorflow \
  python script.py
```
...
The Bitnami Tensorflow Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
...
```console
docker run --name tensorflow bitmoa/tensorflow:latest
```
