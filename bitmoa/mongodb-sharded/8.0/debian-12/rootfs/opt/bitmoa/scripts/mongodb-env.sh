...
# Paths
export PATH="$BITMOA_ROOT_DIR/mongodb/bin:$BITMOA_ROOT_DIR/common/bin:$PATH"
export MONGODB_VOLUME_DIR="$BITMOA_VOLUME_DIR/mongodb"
export MONGODB_BASE_DIR="$BITMOA_ROOT_DIR/mongodb"
