...
```console
docker run -it --name pinniped-cli bitmoa/pinniped-cli
```
...
The recommended way to get the Bitnami Pinniped CLI Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/pinniped-cli).

```console
docker pull bitmoa/pinniped-cli:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/pinniped-cli/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/pinniped-cli:[TAG]
```
...
```console
docker run --name pinniped-cli bitmoa/pinniped-cli:latest
```
...
```console
docker run --rm --name pinniped-cli bitmoa/pinniped-cli:latest --help
```
...
The Bitnami Pinniped CLI Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
