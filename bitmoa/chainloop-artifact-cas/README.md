...
The recommended way to get the Bitnami Chainloop Artifact CAS Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/chainloop-artifact-cas).

```console
docker pull bitmoa/chainloop-artifact-cas:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/chainloop-artifact-cas/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/chainloop-artifact-cas:[TAG]
```
