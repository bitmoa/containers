...
```console
docker run -it --name deepspeed bitmoa/deepspeed:latest
```
...
The recommended way to get the Bitnami DeepSpeed Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/deepspeed).

```console
docker pull bitmoa/deepspeed:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/deepspeed/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/deepspeed:[TAG]
```
...
```console
docker run --name deepspeed bitmoa/deepspeed:latest
```
...
```console
docker run --rm --name deepspeed bitmoa/deepspeed:latest --help
```
...
The Bitnami DeepSpeed Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
