...
```console
docker run --name oauth2-proxy bitmoa/oauth2-proxy:latest
```
...
The recommended way to get the Bitnami oauth2-proxy Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/oauth2-proxy).

```console
docker pull bitmoa/oauth2-proxy:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/oauth2-proxy/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/oauth2-proxy:[TAG]
```
...
```console
docker run --name oauth2-proxy-node1 --network oauth2-proxy-network bitmoa/oauth2-proxy:latest
```
...
The Bitnami OAuth2 Proxy Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
...
We'd love for you to contribute to this container. You can request new features by creating an [issue](https://github.com/bitmoa/containers/issues/new) or submitting a [pull
request](https://github.com/bitmoa/containers/pulls/new) with your contribution.
