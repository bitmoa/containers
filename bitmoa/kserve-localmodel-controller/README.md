...
The recommended way to get the Bitnami KServe Local Model Controller Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/kserve-localmodel-controller).
