...
# case someone mounts a configuration file in opt/bitmoa/wildfly/standalone)
...
if [[ "$1" = "/opt/bitmoa/scripts/wildfly/run.sh" ]]; then
    info "** Starting WildFly setup **"
    /opt/bitmoa/scripts/wildfly/setup.sh
