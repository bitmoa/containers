...
```console
docker run -it --name opensearch-dashboards bitmoa/opensearch-dashboards:latest
```
...
The recommended way to get the Bitnami OpenSearch Dashboards Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/opensearch-dashboards).

```console
docker pull bitmoa/opensearch-dashboards:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/opensearch-dashboards/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/opensearch-dashboards:[TAG]
```
...
```console
docker run --name opensearch-dashboards bitmoa/opensearch-dashboards:latest
```
...
| `OPENSEARCH_DASHBOARDS_VOLUME_DIR`          | Opensearch Dashboards persistence directory                                                   | `${BITMOA_VOLUME_DIR}/opensearch-dashboards`  |
| `OPENSEARCH_DASHBOARDS_BASE_DIR`            | Opensearch Dashboards installation directory                                                  | `${BITMOA_ROOT_DIR}/opensearch-dashboards`    |
...
```console
docker run --rm --name opensearch-dashboards bitmoa/opensearch-dashboards:latest --help
```
...
The Bitnami OpenSearch Dashboards Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
