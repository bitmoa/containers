...
```console
docker run -it --name argo-workflow-exec bitmoa/argo-workflow-exec:latest
```
...
The recommended way to get the Bitnami Argo Workflows Executor Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/argo-workflow-exec).

```console
docker pull bitmoa/argo-workflow-exec:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/argo-workflow-exec/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/argo-workflow-exec:[TAG]
```
...
```console
docker run --name argo-workflow-exec bitmoa/argo-workflow-exec:latest
```
...
```console
docker run --rm --name argo-workflow-exec bitmoa/argo-workflow-exec:latest --help
```
...
The Bitnami Argo Workflow Executor Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
