...
[https://github.com/bitmoa/containers/tree/main/bitmoa/grafana/docker-compose.yml](https://github.com/bitmoa/containers/tree/main/bitmoa/grafana/docker-compose.yml)
...
As an alternative to install this plugin, you can use the [Grafana Image Renderer container](https://github.com/bitmoa/containers/blob/main/bitmoa/grafana-image-renderer) to set another Docker container for rendering and using remote rendering. We highly recommend to use this option.
