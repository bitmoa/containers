...
```console
docker run -it --name gitlab-runner-helper bitmoa/gitlab-runner-helper
```
...
The recommended way to get the Bitnami Gitlab Runner Helper Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/gitlab-runner-helper).

```console
docker pull bitmoa/gitlab-runner:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/gitlab-runner-helper/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/gitlab-runner-helper:[TAG]
```
...
```console
docker pull bitmoa/gitlab-runner-helper:latest
```
...
```console
docker run --name gitlab-runner-helper bitmoa/gitlab-runner-helper:latest
```
...
```console
docker run --rm --name gitlab-runner-helper bitmoa/gitlab-runner–helper:latest --help
```
...
The Bitnami Gitlab Runner Helper Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
