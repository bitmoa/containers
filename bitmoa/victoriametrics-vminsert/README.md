...
```console
docker run --name victoriametrics-vminsert bitmoa/victoriametrics-vminsert:latest
```
...
The recommended way to get the Bitnami VictoriaMetrics Insert Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/victoriametrics-vminsert).

```console
docker pull bitmoa/victoriametrics-vminsert:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/victoriametrics-vminsert/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/victoriametrics-vminsert:[TAG]
```
...
```console
docker run --rm --name victoriametrics-vminsert bitmoa/victoriametrics-vminsert:latest --  --help
```
