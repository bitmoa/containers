...
```console
docker run -it --name argo-cd bitmoa/argo-cd:latest
```
...
The recommended way to get the Bitnami Argo CD Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/argo-cd).

```console
docker pull bitmoa/argo-cd:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/argo-cd/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/argo-cd:[TAG]
```
...
```console
docker run --name argo-cd bitmoa/argo-cd:latest
```
...
```console
docker run --rm --name argo-cd bitmoa/argo-cd:latest --help
```
...
The Bitnami Argo CD Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
