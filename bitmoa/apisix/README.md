...
```console
docker run -it --name apisix bitmoa/apisix:latest
```
...
The recommended way to get the Bitnami Apache APISIX Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/apisix).

```console
docker pull bitmoa/apisix:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/apisix/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/apisix:[TAG]
```
...
```console
docker run --name apisix bitmoa/apisix:latest
```
...
```console
docker run --rm --name apisix bitmoa/apisix:latest --help
```
...
The Bitnami Apache APISIX Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
