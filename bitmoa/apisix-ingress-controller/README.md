...
```console
docker run -it --name apisix-ingress-controller bitmoa/apisix-ingress-controller:latest
```
...
The recommended way to get the Bitnami Apache APISIX Ingress Controller Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/apisix-ingress-controller).

```console
docker pull bitmoa/apisix-ingress-controller:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/apisix-ingress-controller/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/apisix-ingress-controller:[TAG]
```
...
```console
docker run --name apisix-ingress-controller bitmoa/apisix-ingress-controller:latest
```
...
```console
docker run --rm --name apisix-ingress-controller bitmoa/apisix-ingress-controller:latest --help
```
...
The Bitnami Apache APISIX Ingress Controller Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
