...
The recommended way to get the Bitnami KServe Local Model Node Agent Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/kserve-localmodelnode-agent).
