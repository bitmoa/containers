...
```console
docker run -it --name jwt-cli bitmoa/jwt-cli
```
...
The recommended way to get the Bitnami JWT CLI Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/jwt-cli).

```console
docker pull bitmoa/jwt-cli:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/jwt-cli/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/jwt-cli:[TAG]
```
...
```console
docker run --name jwt-cli bitmoa/jwt-cli:latest
```
...
```console
docker run --rm --name jwt-cli bitmoa/jwt-cli:latest --help
```
...
The Bitnami JWT CLI Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
