...
```console
docker run -it --name kuberay-apiserver bitmoa/kuberay-apiserver
```
...
The recommended way to get the Bitnami KubeRay API Server Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/kuberay-apiserver).

```console
docker pull bitmoa/kuberay-apiserver:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/kuberay-apiserver/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/kuberay-apiserver:[TAG]
```
...
```console
docker run --name kuberay-apiserver bitmoa/kuberay-apiserver:latest
```
...
```console
docker run --rm --name kuberay-apiserver bitmoa/kuberay-apiserver:latest --help
```
...
The Bitnami KubeRay API Server Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
