...
# Paths
export GITEA_BASE_DIR="${BITMOA_ROOT_DIR}/gitea"
...
export GITEA_VOLUME_DIR="${BITMOA_VOLUME_DIR}/gitea"
...
export GITEA_ADMIN_PASSWORD="${GITEA_ADMIN_PASSWORD:-bitmoa}"
export GITEA_ADMIN_EMAIL="${GITEA_ADMIN_EMAIL:-user@bitmoa.org}"
...
export GITEA_DATABASE_NAME="${GITEA_DATABASE_NAME:-bitmoa_gitea}"
...
export PATH="/opt/bitmoa/common/bin:/opt/bitmoa/gitea/bin:$PATH"
