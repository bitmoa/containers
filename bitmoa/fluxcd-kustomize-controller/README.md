...
```console
docker run -it --name fluxcd-kustomize-controller bitmoa/fluxcd-kustomize-controller
```
...
The recommended way to get the Bitnami Flux Kustomize Controller Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/fluxcd-kustomize-controller).

```console
docker pull bitmoa/fluxcd-kustomize-controller:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/fluxcd-kustomize-controller/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/fluxcd-kustomize-controller:[TAG]
```
...
```console
docker run --name fluxcd-kustomize-controller bitmoa/fluxcd-kustomize-controller:latest
```
...
```console
docker run --rm --name fluxcd-kustomize-controller bitmoa/fluxcd-kustomize-controller:latest --help
```
...
The Bitnami Flux Kustomize Controller Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
