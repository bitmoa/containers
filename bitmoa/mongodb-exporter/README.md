...
```console
docker run --name mongodb-exporter bitmoa/mongodb-exporter:latest
```
...
The recommended way to get the Bitnami MongoDB Exporter Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/mongodb-exporter).

```console
docker pull bitmoa/mongodb-exporter:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/mongodb-exporter/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/mongodb-exporter:[TAG]
```
...
```console
docker run --name mongodb-exporter-node1 --network mongodb-exporter-network bitmoa/mongodb-exporter:latest
```
...
The Bitnami MongoDB Exporter Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
