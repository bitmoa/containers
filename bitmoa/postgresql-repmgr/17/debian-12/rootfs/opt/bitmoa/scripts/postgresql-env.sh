...
# Paths
export POSTGRESQL_VOLUME_DIR="${POSTGRESQL_VOLUME_DIR:-/bitmoa/postgresql}"
...
export PATH="${POSTGRESQL_BIN_DIR}:${BITMOA_ROOT_DIR}/common/bin:${PATH}"
...
export PATH="/opt/bitmoa/repmgr/bin:/opt/bitmoa/common/bin:$PATH"
export REPMGR_BASE_DIR="/opt/bitmoa/repmgr"
export REPMGR_CONF_DIR="$REPMGR_BASE_DIR/conf"
export REPMGR_VOLUME_DIR="/bitmoa/repmgr"
