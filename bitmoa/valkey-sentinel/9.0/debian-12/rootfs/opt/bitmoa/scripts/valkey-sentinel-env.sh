...
# Paths
export VALKEY_SENTINEL_VOLUME_DIR="/bitmoa/valkey-sentinel"
export VALKEY_SENTINEL_BASE_DIR="${BITMOA_ROOT_DIR}/valkey-sentinel"
...
export PATH="${VALKEY_SENTINEL_BIN_DIR}:${BITMOA_ROOT_DIR}/common/bin:${PATH}"
