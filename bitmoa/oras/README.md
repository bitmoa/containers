...
```console
docker run --name oras bitmoa/oras:latest
```
...
The recommended way to get the Bitnami ORAS Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/oras).

```console
docker pull bitmoa/oras:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/oras/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/oras:[TAG]
```
...
```console
docker run --rm --name oras bitmoa/oras:latest --version
```
