...
```console
docker run --name pinniped bitmoa/pinniped:latest
```
...
The recommended way to get the Bitnami pinniped Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/pinniped).

```console
docker pull bitmoa/pinniped:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/pinniped/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/pinniped:[TAG]
```
...
```console
docker run --rm --name pinniped bitmoa/pinniped:latest --  --help
```
