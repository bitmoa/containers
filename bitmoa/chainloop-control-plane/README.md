...
The recommended way to get the Bitnami Chainloop Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/chainloop-control-plane).

```console
docker pull bitmoa/chainloop-control-plane:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/chainloop-control-plane/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/chainloop-control-plane:[TAG]
```
