...
# Paths
export BITMOA_VOLUME_DIR="/bitmoa"
export EJBCA_BASE_DIR="${BITMOA_ROOT_DIR}/ejbca"
...
# Persistence
export EJBCA_VOLUME_DIR="${BITMOA_VOLUME_DIR}/ejbca"
export EJBCA_WILDFLY_VOLUME_DIR="${BITMOA_VOLUME_DIR}/wildfly"
...
# Wildfly
export EJBCA_WILDFLY_BASE_DIR="${BITMOA_ROOT_DIR}/wildfly"
