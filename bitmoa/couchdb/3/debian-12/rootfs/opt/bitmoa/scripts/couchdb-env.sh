...
couchdb_env_vars=(
    ...
    COUCHDB_SECRET
    COUCHDB_ERLANG_HMAX
    COUCHDB_EXTRA_VM_ARGS
    COUCHDB_INTERNODE_TLS_ENABLED
...
export COUCHDB_PERSISTENT_CONF_FILE="${COUCHDB_VOLUME_DIR}/persist-conf/99-runtime-conf.ini"
...
export COUCHDB_IGNORE_INITDB_SCRIPTS="${COUCHDB_IGNORE_INITDB_SCRIPTS:-no}"
...
export COUCHDB_ERLANG_HMAX="${COUCHDB_ERLANG_HMAX:-}"
export COUCHDB_EXTRA_VM_ARGS="${COUCHDB_EXTRA_VM_ARGS:-}"
export COUCHDB_INTERNODE_TLS_ENABLED="${COUCHDB_INTERNODE_TLS_ENABLED:-no}"
