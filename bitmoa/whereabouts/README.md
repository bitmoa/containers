...
```console
docker run -it --name whereabouts bitmoa/whereabouts
```
...
The recommended way to get the Bitnami Whereabouts Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/whereabouts).

```console
docker pull bitmoa/whereabouts:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/whereabouts/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/whereabouts:[TAG]
```
...
```console
docker run --name whereabouts bitmoa/whereabouts:latest
```
...
```console
docker run --rm --name whereabouts bitmoa/whereabouts:latest --help
```
...
The Bitnami Whereabouts Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
