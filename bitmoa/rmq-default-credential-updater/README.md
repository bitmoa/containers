...
```console
docker run --name rmq-default-credential-updater bitmoa/rmq-default-credential-updater:latest
```
...
```console
docker pull bitmoa/rmq-default-credential-updater:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/rmq-default-credential-updater/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/rmq-default-credential-updater:[TAG]
```
