...
```console
docker run --name chainloop-control-plane bitmoa/chainloop-control-plane:latest
```
...
[https://github.com/bitmoa/containers/tree/main/bitmoa/chainloop-control-plane/docker-compose.yml](https://github.com/bitmoa/containers/tree/main/bitmoa/chainloop-control-plane/docker-compose.yml)

Please be aware this file has not undergone internal testing. Consequently, we advise its use exclusively for development or testing purposes. For production-ready deployments, we highly recommend utilizing its associated [Bitnami Helm chart](https://github.com/bitmoa/charts/tree/main/bitmoa/chainloop).
...
The Bitnami Chainloop Docker image is only available to [Bitnami Secure Images](https://bitnami.com) customers.
...
```console
docker run --rm --name chainloop-control-plane bitmoa/chainloop-control-plane:latest help
```
...
The Bitnami Chainloop Docker image from the [Bitnami Secure Images](https://go-vmware.broadcom.com/contact-us) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
