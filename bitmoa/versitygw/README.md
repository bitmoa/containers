...
```console
docker run --name versitygw bitmoa/versitygw:latest
```
...
The recommended way to get the Bitnami Versity S3 Gateway Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/versitygw).

```console
docker pull bitmoa/versitygw:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/versitygw/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/versitygw:[TAG]
```
...
```console
docker run --rm --name versitygw bitmoa/versitygw:latest -- --help
```
