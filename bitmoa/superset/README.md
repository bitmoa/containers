...
[https://github.com/bitmoa/containers/tree/main/bitmoa/superset/docker-compose.yml](https://github.com/bitmoa/containers/tree/main/bitmoa/superset/docker-compose.yml)

Please be aware this file has not undergone internal testing. Consequently, we advise its use exclusively for development or testing purposes. For production-ready deployments, we highly recommend utilizing its associated [Bitnami Helm chart](https://github.com/bitmoa/charts/tree/main/bitmoa/superset).
...
The Bitnami Apache Superset Docker image is only available to [Bitnami Secure Images](https://bitnami.com) customers.
