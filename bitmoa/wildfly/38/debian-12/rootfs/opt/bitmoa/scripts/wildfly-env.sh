...
# Paths
export WILDFLY_BASE_DIR="${BITMOA_ROOT_DIR}/wildfly"
...
export WILDFLY_VOLUME_DIR="${BITMOA_VOLUME_DIR}/wildfly"
...
export PATH="${WILDFLY_BIN_DIR}:${BITMOA_ROOT_DIR}/common/bin:${PATH}"
