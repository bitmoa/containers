...
```console
docker run --name redis-exporter bitmoa/redis-exporter:latest
```
...
The recommended way to get the Bitnami Redis Exporter Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/redis-exporter).

```console
docker pull bitmoa/redis-exporter:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/redis-exporter/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/redis-exporter:[TAG]
```
...
```console
docker run --name redis-exporter-node1 --network redis-exporter-network bitmoa/redis-exporter:latest
```
...
The Bitnami Redis Exporter Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
