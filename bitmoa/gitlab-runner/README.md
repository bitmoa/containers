...
```console
docker run -it --name gitlab-runner bitmoa/gitlab-runner
```
...
The recommended way to get the Bitnami Gitlab Runner Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/gitlab-runner).

```console
docker pull bitmoa/gitlab-runner:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/gitlab-runner/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/gitlab-runner:[TAG]
```
...
```console
docker run --name gitlab-runner bitmoa/gitlab-runner:latest
```
...
```console
docker run --rm --name gitlab-runner bitmoa/gitlab-runner:latest --help
```
...
The Bitnami Gitlab Runner Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
