...
The recommended way to get the Bitnami Argo Workflows CLI Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/argo-workflow-cli).

```console
docker pull bitmoa/argo-workflow-cli:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/argo-workflow-cli/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/argo-workflow-cli:[TAG]
```
...
```console
docker run --name argo-workflow-cli bitmoa/argo-workflow-cli:latest
```
