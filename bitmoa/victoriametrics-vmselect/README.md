...
```console
docker run --name victoriametrics-vmselect bitmoa/victoriametrics-vmselect:latest
```
...
The recommended way to get the Bitnami VictoriaMetrics Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/victoriametrics-vmselect).

```console
docker pull bitmoa/victoriametrics-vmselect:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/victoriametrics-vmselect/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/victoriametrics-vmselect:[TAG]
```
...
```console
docker run --rm --name victoriametrics-vmselect bitmoa/victoriametrics-vmselect:latest --  --help
```
