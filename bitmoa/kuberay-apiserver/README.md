# Bitnami Secure Image for KubeRay API Server
...
The Bitnami KubeRay API Server Docker image is only available to [Bitnami Secure Images](https://bitnami.com) customers.
