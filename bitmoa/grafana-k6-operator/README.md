...
```console
docker run --name grafana-k6-operator bitmoa/grafana-k6-operator:latest
```
...
The recommended way to get the Bitnami Grafana k6 Operator Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/grafana-k6-operator).

```console
docker pull bitmoa/grafana-k6-operator:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/grafana-k6-operator/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/grafana-k6-operator:[TAG]
```
...
```console
docker run --rm --name grafana-k6-operator bitmoa/grafana-k6-operator:latest --  --help
```
