...
The recommended way to get the Bitnami VictoriaMetrics Auth Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/victoriametrics-vmauth).

```console
docker pull bitmoa/victoriametrics-vmauth:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/victoriametrics-vmauth/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/victoriametrics-vmauth:[TAG]
```
