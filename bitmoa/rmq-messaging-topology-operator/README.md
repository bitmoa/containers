...
```console
docker run --name rmq-default-credential-updater bitmoa/rmq-messaging-topology-operator:latest
```
...
The recommended way to get the Bitnami rmq-default-credential-updater Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/rmq-default-credential-updater).

```console
docker pull bitmoa/rmq-messaging-topology-operator:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/rmq-messaging-topology-operator/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/rmq-messaging-topology-operator:[TAG]
```
...
```console
docker run --rm --name rmq-default-credential-updater bitmoa/rmq-default-credential-updater:latest --  --help
```
