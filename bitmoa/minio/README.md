...
[https://github.com/bitmoa/containers/tree/main/bitmoa/minio/docker-compose.yml](https://github.com/bitmoa/containers/tree/main/bitmoa/minio/docker-compose.yml)
...
Deploying Bitnami applications as Helm Charts is the easiest way to get started with our applications on Kubernetes. Read more about the installation in the [Bitnami MinIO(R) Chart GitHub repository](https://github.com/bitmoa/charts/tree/master/bitmoa/minio).
...
|------------------------------------------|----------------------------------------------------------------------------|----------------------------------------------------|
| `MINIO_DATA_DIR`                         | MinIO directory for data.                                                  | `/bitmoa/minio/data`                              |
...
|----------------------|---------------------------------------|-------------------------------|
| `MINIO_BASE_DIR`     | MinIO installation directory.         | `${BITMOA_ROOT_DIR}/minio`   |
...
```console
docker run --name minio -d bitmoa/minio:latest
