...
[https://github.com/bitmoa/containers/tree/main/bitmoa/kafka/docker-compose.yml](https://github.com/bitmoa/containers/tree/main/bitmoa/kafka/docker-compose.yml)
...
> Note: If you have already started using your data, preserve the `/bitmoa/kafka` volume contents before removing the container so you can mount the same data in a new container.
