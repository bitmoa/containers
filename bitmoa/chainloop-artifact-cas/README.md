...
```console
docker run --name chainloop-artifact-cas bitmoa/chainloop-artifact-cas:latest
```
...
[https://github.com/bitmoa/containers/tree/main/bitmoa/chainloop-artifact-cas/docker-compose.yml](https://github.com/bitmoa/containers/tree/main/bitmoa/chainloop-artifact-cas/docker-compose.yml)
...
```console
docker run --rm --name chainloop-artifact-cas bitmoa/chainloop-artifact-cas:latest help
```
