...
```console
docker run --name jupyter-base-notebook bitmoa/jupyter-base-notebook:latest
```
...
The recommended way to get the Bitnami jupyter-base-notebook Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/jupyter-base-notebook).

```console
docker pull bitmoa/jupyter-base-notebook:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/jupyter-base-notebook/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/jupyter-base-notebook:[TAG]
```
...
```console
docker run --rm --name jupyter-base-notebook bitmoa/jupyter-base-notebook:latest -- jupyterhub-singleuser --version
```
...
```Dockerfile
FROM bitmoa/jupyter-base-notebook:latest
USER root
...
The Bitnami Jupyter Base Notebook Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
