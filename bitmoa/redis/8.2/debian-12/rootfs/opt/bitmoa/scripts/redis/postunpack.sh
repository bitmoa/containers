...
. /opt/bitmoa/scripts/redis-env.sh

# Load libraries
. /opt/bitmoa/scripts/libredis.sh
...
chmod -R g+rwX /bitmoa "$REDIS_VOLUME_DIR" "$REDIS_BASE_DIR"
...
# Ref 2: https://github.com/bitmoa/bitmoa-docker-redis/pull/115
redis_conf_set save ""
