...
```console
docker run -it --name argo-workflow-controller bitmoa/argo-workflow-controller
```
...
The recommended way to get the Bitnami Argo Workflows Controller Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/argo-workflow-controller).

```console
docker pull bitmoa/argo-workflow-controller:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/argo-workflow-controller/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/argo-workflow-controller:[TAG]
```
...
```console
docker run --name argo-workflow-controller bitmoa/argo-workflow-controller:latest
```
...
```console
docker run --rm --name argo-workflow-controller bitmoa/argo-workflow-controller:latest --help
```
