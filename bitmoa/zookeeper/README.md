...
docker run --name zookeeper \
  -v /path/to/domain.key:/bitmoa/zookeeper/certs/domain.key:ro
  -v /path/to/domain.crs:/bitmoa/zookeeper/certs/domain.crs:ro
  -e ALLOW_EMPTY_PASSWORD=yes \
  -e ZOO_TLS_CLIENT_ENABLE=yes \
  -e ZOO_TLS_CLIENT_KEYSTORE_FILE=/bitmoa/zookeeper/certs/domain.key\
  -e ZOO_TLS_CLIENT_TRUSTSTORE_FILE=/bitmoa/zookeeper/certs/domain.crs\
  bitmoa/zookeeper:latest
```
