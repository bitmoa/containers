...
# Paths
export BITMOA_VOLUME_DIR="/bitmoa"
export OPENSEARCH_DASHBOARDS_VOLUME_DIR="${BITMOA_VOLUME_DIR}/opensearch-dashboards"
export SERVER_VOLUME_DIR="$OPENSEARCH_DASHBOARDS_VOLUME_DIR"
export OPENSEARCH_DASHBOARDS_BASE_DIR="${BITMOA_ROOT_DIR}/opensearch-dashboards"
