...
```console
docker run --name kserve-localmodelnode-agent bitmoa/kserve-localmodelnode-agent:latest
```
...
The recommended way to get the Bitnami KServe Local Model Controller Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/kserve-localmodelnode-agent).

```console
docker pull bitmoa/kserve-localmodelnode-agent:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/kserve-localmodelnode-agent/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/kserve-localmodelnode-agent:[TAG]
```
...
```console
docker run --rm --name kserve-localmodelnode-agent bitmoa/kserve-localmodelnode-agent:latest --  --help
```
