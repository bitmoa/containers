...
```console
docker run -it --name multus-cni bitmoa/multus-cni:latest
```
...
The recommended way to get the Bitnami Multus CNI Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/multus-cni).

```console
docker pull bitmoa/multus-cni:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/multus-cni/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/multus-cni:[TAG]
```
...
```console
docker run --name multus-cni bitmoa/multus-cni:latest
```
...
```console
docker run --rm --entrypoint /opt/bitmoa/multus-cni/bin/multus-daemon --name multus-cni bitmoa/multus-cni:latest --help
```
...
The Bitnami Multus CNI Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
