...
# Paths
export SCANNER_TRIVY_BASE_DIR="${BITMOA_ROOT_DIR}/harbor-adapter-trivy"
export SCANNER_TRIVY_VOLUME_DIR="${SCANNER_TRIVY_VOLUME_DIR:-${BITMOA_VOLUME_DIR}/harbor-adapter-trivy}"
