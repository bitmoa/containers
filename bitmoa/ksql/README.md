...
```console
docker run --name ksql bitmoa/ksql:latest
```
...
The recommended way to get the Bitnami ksql Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/ksql).

```console
docker pull bitmoa/ksql:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/ksql/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/ksql:[TAG]
```
...
|----------------------------------|-------------------------------------------------------------------------------------------|-------------------------------------------|
| `KSQL_BASE_DIR`                  | Base path for KSQL files.                                                                 | `${BITMOA_ROOT_DIR}/ksql`                |
| `KSQL_VOLUME_DIR`                | KSQL directory for persisted files.                                                       | `${BITMOA_VOLUME_DIR}/ksql`              |
...
The Bitnami Confluent KSQL DB Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
