...
```console
docker run -it --name apisix-dashboard bitmoa/apisix-dashboard:latest
```
...
The recommended way to get the Bitnami Apache APISIX Dashboard Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/apisix-dashboard).

```console
docker pull bitmoa/apisix-dashboard:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/apisix-dashboard/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/apisix-dashboard:[TAG]
```
...
```console
docker run --name apisix-dashboard bitmoa/apisix-dashboard:latest
```
...
```console
docker run --rm --name apisix-dashboard bitmoa/apisix-dashboard:latest --help
```
...
The Bitnami Apache APISIX Dashboard Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
