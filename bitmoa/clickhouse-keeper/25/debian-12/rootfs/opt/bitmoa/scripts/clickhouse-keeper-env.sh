...
# Paths
export CLICKHOUSE_KEEPER_BASE_DIR="${BITMOA_ROOT_DIR}/clickhouse-keeper"
export CLICKHOUSE_KEEPER_VOLUME_DIR="/bitmoa/clickhouse-keeper"
...
export PATH="${CLICKHOUSE_KEEPER_BASE_DIR}/bin:${BITMOA_ROOT_DIR}/common/bin:$PATH"
