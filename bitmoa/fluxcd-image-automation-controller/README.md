...
```console
docker run -it --name fluxcd-image-automation-controller bitmoa/fluxcd-image-automation-controller
```
...
The recommended way to get the Bitnami Flux Image Automation Controller Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitmoa/fluxcd-image-automation-controller).

```console
docker pull bitmoa/fluxcd-image-automation-controller:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitmoa/fluxcd-image-automation-controller/tags/) in the Docker Hub Registry.

```console
docker pull bitmoa/fluxcd-image-automation-controller:[TAG]
```
...
```console
docker run --name fluxcd-image-automation-controller bitmoa/fluxcd-image-automation-controller:latest
```
...
```console
docker run --rm --name fluxcd-image-automation-controller bitmoa/fluxcd-image-automation-controller:latest --help
```
...
The Bitnami Flux Image Automation Controller Docker image from the [Bitnami Secure Images](https://www.arrow.com/globalecs/uk/products/bitmoa-secure-images/) catalog includes extra features and settings to configure the container with FIPS capabilities. You can configure the next environment variables:
